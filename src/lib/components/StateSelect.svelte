<script>
	...
	Select.prototype.init = function () {
		...
		this.comboEl.innerHTML = this.options[0].name;
	...
	Select.prototype.createOption = function (optionText, index) {
		...
		optionEl.setAttribute('data-abbr', optionText.abbreviation);
		optionEl.id = `${this.idBase}-${index}`;
		optionEl.className = index === 0 ? 'combo-option option-current' : 'combo-option';
		optionEl.setAttribute('aria-selected', `${index === 0}`);
		optionEl.innerText = optionText.name;
	...
	Select.prototype.selectOption = function (index) {
		...
		this.comboEl.innerHTML = selected.name;
...
<div class="form-control">
	<label id="combo1-label" class="combo-label">State</label>
