...
const registerSchema = z.object({
    ...
    postal: z.string({ required_error: 'Postal / Zip code is required!' }).min(1, { message: 'Postal / Zip code is required!' }).max(64, { message: 'Zip / Postal must be less than 64 characters.' }).trim()
})
